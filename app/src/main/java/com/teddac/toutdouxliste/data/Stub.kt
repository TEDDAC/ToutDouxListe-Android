...
class Stub {
    val tasks = mutableListOf(
        ...
        Task(title = "Another thing to do", description = "thins that you do (by Slynk)", isDone = true, date = LocalDateTime.parse("2024-06-18T12:30:00")),
        ...
        Task(title = "Walk the dog", description = "I have a dog ?!", isDone = false, date = LocalDateTime.parse("2024-05-18T18:25:00")),
